-- Fix web_create_upgrade_order and web_get_upgrade_order_status:
-- Resolves internal user_id via public.get_linked_user_id() instead of raw auth.uid(),
-- preventing foreign key violation (409 Conflict) on payment_orders.user_id.
